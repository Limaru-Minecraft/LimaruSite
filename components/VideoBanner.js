    ...
    <div className="h-5/6 bg-slate-500 bg-[url('/1800.png')] bg-cover">
        {showVideo ? (
            <div className="h-full relative flex justify-center">
                ...
                src="https://www.youtube-nocookie.com/embed/DX7kYO1slDs?autoplay=1&cc_load_policy=1"
            ...
            <div className="py-48 flex justify-center">
                <div className="flex flex-col items-start justify-center max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    <h1 className="text-6xl text-white font-bold mb-6">
                        Welcome to Limaru
                    </h1>
                    <p className="text-xl text-white text-left mb-8">
                    ...
                    <button
                        onClick={handleClick}
                        className="flex items-center space-x-2 py-2 px-4 mb-8 bg-stone-800 border-4 border-stone-300 rounded-md font-semibold text-white hover:border-yellow-300 hover:shadow-xl shadow-yellow-400 focus:outline-none focus:ring-2"
                        title="Click to copy!"
                        >
                    ...
                    <button onClick={handlePlayButtonClick} className="relative z-10 flex items-center justify-center bg-white w-16 h-16 rounded-full">
