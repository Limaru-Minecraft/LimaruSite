      ...
      {items.map((item) => (
        item.url ? (
          <Link
            href={item.url}
            key={item.title}
            className="flex flex-col justify-end w-full aspect-[10] text-white border rounded-md transition duration-300 bg-cover bg-center shadow-[inset_200px_-200px_200px_-200px_rgba(0,0,0,0.6)] hover:-translate-y-1 hover:bg-yellow-400 "
