  ...
  return (
    <div className="p-4">
      {routeSegments.length > 0 ? (
        <h2 className="flex flex-col md:flex-row text-xl font-bold mb-4">
          Suggested Route
          <div className="flex md:ml-6 items-center text-lg font-medium">
            <span>{origin}</span>
            <Image
            ...
            />
            <span>{destination} ({stations.length} stops)</span>
          </div>
        </h2>
      ) : (
        <div />
      ...
      {routeSegments.length > 0 ? (
            ...
            stations.map((station, index) => {
              ...
              if (transferIndex !== -1) {
                ...
                freq = frequency
                  ...
                  : ""; // Avoid fallbacks to unrelated segments
              }
                ...
                <React.Fragment key={index}>
                  ...
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
                      ...
                      {index === 0 ? (
                        <div
                          className="h-16 flex flex-col items-start"
                          style={{
                            backgroundColor:
                              routeSegments[0]?.color || "#2b2b2b",
                            marginTop: "-4px",
                            width: "4px",
                          }}
                        >
                          <div className="flex items-center">
                            ...
                            <img
                              ...
                              className={`absolute w-6 h-6 top-23 left-2.5 transform -translate-x-1/2 ${
                                isDark(routeSegments[0]?.color || "#2b2b2b")
                                  ? "invert"
                                  : ""
                              }`}
                              style={{
                                marginTop: route.includes("Bus")
                                  ? "8px"
                                  : "7px",
                                marginLeft: "38px",
                              }}
                            ...
                            >
                              <span
                                className="ml-7"
                                style={{
                                  marginLeft: transferPoints.includes(station)
                                    ? "16px"
                                    : "",
                                }}
                              >
                    ...
                    <div className="flex items-center">
                      <div className="flex flex-col items-center">
                        <div
                          ...
                          style={{ borderLeft: "4px dotted #2b2b2b" }}
                        ></div>
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <img
                              ...
                              alt="Transport Icon"
                              className={`absolute w-6 h-6 top-23 left-2.5 transform -translate-x-1/2 ${
                                isDark(routeSegments[index]?.color || "#2b2b2b")
                                  ? "invert"
                                  : ""
                              }`}
                              style={{
        ...
        <p>Error: The origin station is same as your destination.</p>
      ) : (
        <p>
          Error: We&apos;re sorry, but we can&apos;t find a possible route.
          Please ensure that the origin and destination are different. If you
          think this is an error, please report it through the #helpop system!
        </p>
      )}
      <div className="mt-4">
        <button
